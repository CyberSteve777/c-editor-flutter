...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get targetWaveIndexHelper =>
      'Проведите по столбцу пустых флажков, чтобы быстро выбрать несколько волн. Начните с отмеченного флажка, чтобы последовательно снимать выделение. При копировании ссылок волны, уже содержащие это событие, автоматически пропускаются.';
