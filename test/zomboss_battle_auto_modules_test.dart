...
void main() {
  ...
  setUpAll(ZombossBattleRepository.init);
  ...
  test('leaving Underground Palace always removes timer and can keep tunnels', () {
    final fixture = _levelFixture();
    ZombossBattleRepository.ensureAutoModules(
      levelFile: fixture.levelFile,
      levelDef: fixture.levelDef,
...
PvzObject _tunnelObject(PvzLevelFile levelFile) => levelFile.objects.singleWhere(
  (object) => object.aliases?.contains('TunnelDefend') == true,
);
