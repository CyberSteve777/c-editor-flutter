...
/// `team.international2c.preview_img` is rejected by the host — the artifact
...
void main() {
  ...
  test('compile level_preview.cplugin from eval_src', () {
    ...
    const packageName = 'preview_img_cplugin';
    const fileName = 'main.dart';
    const library = 'package:preview_img_cplugin/main.dart';
    const pluginId = 'team.international2c.preview_img';
    ...
    final outDir = Directory('build/preview_img_cplugin');
