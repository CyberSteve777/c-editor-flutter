...
- Removed broken `example/integration_test` counter-template tests (they do not match this package's example app and are unused by C-Editor). Excluded `example/**` from the root analyzer.
